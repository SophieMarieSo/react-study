...
import { Badge, Col, Container, Dropdown, Image, Row } from 'react-bootstrap';
    ...
    <Container className='detail'>
      <Row>
        ...
        <Col lg={6} sm={12} className='m-3'>
          ...
          <h4 className='price'>₩ {product?.price?.toLocaleString('ko-KR')}</h4>
          <div className='click-section'>
            <Dropdown>
              <Dropdown.Toggle variant='danger'>사이즈 선택</Dropdown.Toggle>
